...
def model_builder(hp):
    ...
    x = layers.Dense(units=hp.Int('dense_units', min_value=32, max_value=128, step=32), activation='relu')(x)
...
def run_fn(fn_args: FnArgs) -> None:
    ...
    tuner = kt.Hyperband(
        ...
        project_name='sarcasm_model_tuning'
    )
    ...
    signatures = {
        'serving_default': _get_serve_tf_examples_fn(best_model, tf_transform_output).get_concrete_function(
