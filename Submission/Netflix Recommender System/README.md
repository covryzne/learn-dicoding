...
Sistem rekomendasi telah terbukti memainkan peran penting dalam meningkatkan pengalaman pengguna serta mempertahankan tingkat keterlibatan yang tinggi. Bahkan dalam konteks berbeda seperti intervensi kesehatan masyarakat, sistem rekomendasi berbasis preferensi individu menunjukkan efektivitas dalam meningkatkan interaksi pengguna dengan sistem, serta memberikan hasil yang lebih baik dibanding pendekatan umum [1]. Hal ini menunjukkan bahwa pemanfaatan sistem rekomendasi yang dipersonalisasi tidak hanya meningkatkan relevansi konten, tetapi juga berkontribusi pada user-system engagement yang lebih tinggi—faktor penting untuk retensi pengguna baik di bidang kesehatan maupun hiburan digital seperti Netflix.

Referensi: <br>
[1] J. Chen, T. K. Houston, J. M. Faro, C. S. Nagawa, E. A. Orvek, A. C. Blok, J. J. Allison, S. D. Person, B. M. Smith, dan R. S. Sadasivam, "Evaluating the use of a recommender system for selecting optimal messages for smoking cessation: patterns and effects of user-system engagement," BMC Public Health, vol. 21, no. 1749, 2021. [Online]. Tersedia: https://doi.org/10.1186/s12889-021-11803-8
