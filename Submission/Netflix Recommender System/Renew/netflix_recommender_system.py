...
Menghubungkan `Google Drive` ke Google Colab untuk mengakses dataset yang diperlukan.
"""
...
Memuat dataset `netflix_titles.csv` dari Google Drive. Tahap ini bertujuan untuk mempersiapkan data yang akan dianalisis.
"""

df = pd.read_csv('/content/drive/MyDrive/Kuliah/Dicoding/Datasets/netflix_titles.csv')

"""Melakukan cek info dataset untuk menampilkan informasi dasar dari dataset untuk memahami jumlah fitur, tipe data, dan memeriksa apakah ada nilai-nilai yang hilang."""

df.info()

"""Menyesuaikan tipe data pada field `date_added` yaitu datetime"""
...
Memeriksa jumlah dan persentase nilai yang hilang dalam dataset.
"""
...
"Nilai-nilai yang hilang di beberapa kolom seperti `director`, `cast`, `date_added` dan `country` diimputasi dengan 'Unknown', sedangkan nilai `release_year` diisi dengan nilai rata-rata, dan kolom `rating` serta `listed_in` diimputasi dengan modus."
"""
...
Memeriksa kembali apakah semua nilai yang hilang telah ditangani dengan menampilkan kembali jumlah nilai yang kosong setelah proses imputasi.
"""
...
"""# Tren Penambahan Konten Berdasarkan Tahun
...
"""# Negara Teratas dalam Produksi Konten
...
"""# Tren Konten yang Dirilis pada Netflix Tiap Tahun
...
"""# Distribusi Rating Berdasarkan Tipe Konten
...
# Misalkan ini adalah daftar film yang relevan untuk pengguna (ground truth)
